...
| 0001 | A router that picks an open-source model per query, cheaper than always-largest | routing | api-key | SOLVED | [1 verified](<https://example.com/acceptance-1787557538374>) |
<!-- INDEX:END -->
