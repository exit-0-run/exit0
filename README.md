...
| 0019 | Smoke entry: byte size of a pinned file \(write-path exercise, not a real problem\) | other | — | SOLVED best 32664, beat it | [1 verified](<https://github.com/exit-0-run/exit0>) |
<!-- INDEX:END -->
