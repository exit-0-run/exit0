...
<!-- INDEX:START -->
_1 problems, 1 solved. Generated by scripts/build.mjs, do not edit by hand._

| # | Problem | Status | Solutions |
|---|---|---|---|
| 0001 | A router that picks an open-source model per query, cheaper than always-largest | SOLVED | [1 verified](<https://example.com/acceptance-1787517781917>) |
<!-- INDEX:END -->
