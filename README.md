...
| 0014 | Beat a widely used parser on throughput with byte-identical output | other | — | SOLVED best 72.4, beat it, verdict has conditions | [1 verified](<https://github.com/exit-0-run/exit0.git>) |
| 0019 | Smoke entry: byte size of a pinned file \(write-path exercise, not a real problem\) | other | — | dead best 32664, beat it, verdict has conditions | [1 verified](<https://github.com/exit-0-run/exit0>) |
<!-- INDEX:END -->
